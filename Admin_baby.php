<?php 
    ...
    $result = mysqli_query($conn, "SELECT * FROM baby");
        ...
        <table class="table container table-bordered border-danger animals"  style="margin-top:50px;">
            <thead>
              ...
              <tr>
                ...
                <th > المدينة </th>
                <th > المركز </th>
                <th > رقم الولادة بالنسبة للأم </th>
                <th > رقم المولود (أي ترتيبه بين أخواته) </th>
            ...
            <?php
                ...
                if(isset($_GET['search']))
                {
                  ...
                  $querytwo = "SELECT * FROM baby WHERE 	national_ID LIKE '%$filtervalues%' ";
                      ...
                      foreach($query_run as $items)
                        {
                            ...
                            <tr>
                              ...
                              <td><?= $items['city']; ?></td>
                              <td><?= $items['center']; ?></td>
                              <td><?= $items['mother_num']; ?></td>
                              <td><?= $items['child_num']; ?></td>
                              <td><?= $items['hospital_name']; ?></td>
                              <td><?= $items['doctor_name']; ?></td>
                              <td><?= $items['father_id']; ?></td>
                              <td><?= $items['father_job']; ?></td>
                              <td><?= $items['mother_id']; ?></td>
                              <td><?= $items['mother_job']; ?></td>
                            </tr>
                            <?php
                          $i++;
                        }
