...
<head>
    ...
    <link rel="stylesheet" href="css/service_choice.css">
    <link rel="stylesheet" href="css/bootstrap.min.css">
    <link rel="shortcut icon" href="images/logo.png" type="image/x-icon">
    <title>الخدمات المتوفرة   - التأمين الصحي الشامل</title>
</head>
<body>
    ...
    <div class="welcome">
        <div class="container">
            <div class="row">
                <div class="col-md-7 group " style="margin-top: 390px;">
                   

                    <div class="group">
                        <a href="company_service.php">
                            <button style="background-color: rgb(0, 64, 182); width: 300px; font-weight: bold;" class="glow-on-hover mx-3" type="button">
                                الخدمات المتوفرة للشركات و الهيئات
                            </button>
                        </a>
                        <a href="service.php">
                            <button style="background-color: rgb(0, 64, 182); width: 200px;  font-weight: bold;" class="glow-on-hover" type="button">
                                الخدمات المتوفرة للأفراد
                            </button>
                        </a>
                    </div>
                ...
                <div class="col-md">
                    <img src="images/service1.gif" alt="" width="480px" height="500px" style="margin-top: 130px; margin-left: -50px; border-radius: 20px;">
                </div> <!-- End Col -->
            </div> <!-- End Row -->
        </div> <!-- End Container -->
    </div> <!-- End Welcome Div -->
