...
<body>
  ...
  <div class="container">
    ...
    <div class="row mb-5">
      <div class="col-md-6">
        <div class="card1 " style="width: 335px; margin-left: 150px;">
          <img src="images/card three.png" class="card-img-top" alt="...">
          <div class="card-body">
            <h5 class="card-title"> حجز ميعاد للكشف</h5>
            <p class="card-text"> للتنسيق وحجز ميعاد مسبق</p>
            <a href="appointment.php" class="btn btn-primary" style="margin-right: 85px;"> حجز الكشف</a>
          </div>
        </div> <!-- End Card 1 -->
      </div> <!-- End Col -->
      <div class="col-md-6">
        <div class="card2" style="width: 335px; margin-right: -100px;">
          <img src="images/card_one.png" class="card-img-top" alt="...">
          <div class="card-body">
            <h5 class="card-title"> تسجيل مولود جديد </h5>
            <p class="card-text">
              لكي تستطيع التأمين على طفلك والحصول على الخدمات المتاحه عليك التسجيل اولا
            </p>
            <a href="BabyForm1.php" class="btn btn-primary" style="margin-right: 85px;">
              تسجيل المولود
            </a>
          </div>
        </div> <!-- End Card 2 -->
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="card2" style="width: 335px; margin-left: 480px; margin-top: 13px;">
          <img src="images/card_four.png" class="card-img-top" alt="...">
          <div class="card-body">
            <h5 class="card-title"> العمليات الجراحية </h5>
            <p class="card-text"> لحجز موعد مسبق لإجراء عملية جراحية</p>
            <a href="OperationForm.php" class="btn btn-primary">حجز عملية جراحية </a>
          </div>
        </div> <!-- End Card 2 -->
      </div> <!-- End Col -->
    </div> <!-- End Row -->
