...
<body>
  ...
  <div class="help-section">
    <div class="rgba">
        <h5 class="help-title text-center">
    ...
    <div class="help-sections">
        <div class="container">
            <div class="row">
                <div class="col-md-6 help-details" style="margin-right:200px; width: 550px; margin-left:10px">
                    <div class="icon">
                        <i class="far fa-hospital-user"></i>
                    </div>
                    <div class="icon-desc">
                        لإيجاد أقرب مستشفى لموفعك الحالي 
                    </div>
                    <div class="icon-button">
                        <a class="btn btn-secondary" href="hospital_search.php" role="button">إضغط هنا</a>
                    </div>
                </div>
                <div class="col-md-6 ml-3 help-details2" style=" width: 550px;">
                    <div class="icon">
                    ...
                    <div class="icon-button">
                        <a class="btn btn-secondary" href="question.php" role="button">إضغط هنا</a>
                    </div>
                </div>
            </div>
        </div>
  ...
  <!-- End Help Section -->
   ...
   <footer class="bg-light text-center text-white" style="margin-top:350px; ">
          <!-- Grid container -->
